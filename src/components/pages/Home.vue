<template>
  <div id="sections-wrapper" class="text-center rounded border-dotted border-2 border-indigo-600 p-2 m-2">
    ...
    <Popper :class="theme" arrow >
      <button>Trigger element</button>

      <template #content>
        <div class="et-fb-columns-layout">
    ...
    <div>
      <a class="btn btn-primary" href="index.html" @click="addSection">
        Add Section
      </a>
    </div>
...
.et-fb-modules-list .et_fb_specialty_layout_item:nth-of-type(2n) {
  margin-right: 20px;
}
